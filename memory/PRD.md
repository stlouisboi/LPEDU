...
- [x] REACH Diagnostic funnel restructure — Removed full diagnostic UI from homepage; added AuthorityReadinessTestSection with copy + CTA → /reach-diagnostic; created /reach-diagnostic route (alias to REACHAssessmentPage); updated headline copy; Navbar links to /reach-diagnostic (Feb 2026)
