...
- [x] AUTO Method Teaser & Four Pillars enhanced — animated threat diagram (O/A/T/U → YOUR AUTHORITY), staggered card entrance, gold top-border + faded bg numbers + OUTPUT labels on pillar cards (Feb 2026)
