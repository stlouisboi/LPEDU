          ...
          <FadeIn>
            <div>
              ...
              <div style={{
                ...
                background: "rgba(232,89,15,0.03)",
                display: "flex",
                alignItems: "center",
                gap: "1rem",
              }}>
                ...
                <div>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.875rem", fontWeight: 600, color: "var(--text)", marginBottom: "0.15rem" }}>
                    Watch: The 3-Minute System Overview
                  </p>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.78rem", color: "var(--text-subtle)" }}>
