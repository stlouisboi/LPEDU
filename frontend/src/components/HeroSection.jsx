      ...
      <div className="hero-grid" style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 296px", alignItems: "start" }}>
        ...
        <div className="hero-left" style={{ padding: "100px 44px 80px 56px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, fontWeight: 500, letterSpacing: "0.14em", textTransform: "uppercase", color: "#d4900a", margin: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
              <Link to="/ground-0-briefing" data-testid="hero-primary-cta" className="hero-cta-primary"
                style={{ fontFamily: "'Inter', sans-serif", fontSize: 18, fontWeight: 700, letterSpacing: "0.08em", color: "#0b1628", background: "#d4900a", padding: "18px 36px", height: 58, textDecoration: "none", boxShadow: "0 0 0 3px rgba(212,144,10,0.22)", transition: "background 0.2s", display: "inline-flex", alignItems: "center", textTransform: "uppercase" }}
                onMouseEnter={e => (e.currentTarget.style.background = "#e8a520")}
                onMouseLeave={e => (e.currentTarget.style.background = "#d4900a")}
              >INITIATE GROUND 0 →</Link>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "rgba(255,255,255,0.38)", margin: "6px 0 0", letterSpacing: "0.07em", textTransform: "uppercase" }}>Free Readiness Module</p>
            </div>
            <Link to="/standards" data-testid="hero-secondary-cta" className="hero-cta-secondary"
              style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, fontWeight: 500, letterSpacing: "0.04em", color: "rgba(255,255,255,0.65)", background: "transparent", border: "0.5px solid rgba(255,255,255,0.25)", padding: "0 24px", height: 58, textDecoration: "none", transition: "border-color 0.2s, color 0.2s", display: "inline-flex", alignItems: "center", textTransform: "uppercase" }}
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "rgba(255,255,255,0.30)", lineHeight: 1.6, maxWidth: 480, marginBottom: 28, letterSpacing: "0.02em" }}>
          ...
          <div className="proof-mobile" style={{
            ...
            {PROOF.map((item, i) => (
              <div key={i} style={{
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(255,255,255,0.75)", margin: 0, lineHeight: 1.3 }}>
                  {item.label}
                </p>
              </div>
            ))}
        ...
        <div className="hero-right" style={{ borderLeft: "0.5px solid rgba(212,144,10,0.14)", padding: "100px 28px 80px", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(212,144,10,0.50)", margin: "0 0 4px" }}>
              LPOS — RISK ANALYSIS
            </p>
            <p className="hero-rp-label" style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, fontWeight: 700, color: "rgba(212,144,10,0.95)", letterSpacing: "0.14em", textTransform: "uppercase", margin: 0 }}>
          ...
          <div className="hero-risk-card" style={{
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(232,89,48,0.80)", margin: "0 0 8px" }}>EXPOSURE RISK</p>
            ...
            <p className="hero-rp-sub" style={{ fontFamily: "'Inter', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.75)", lineHeight: 1.65, margin: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 0 10px" }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "rgba(255,255,255,0.35)", letterSpacing: "0.12em", textTransform: "uppercase", margin: 0 }}>versus</p>
            <div style={{ flex: 1, height: "0.5px", background: "rgba(255,255,255,0.10)" }} />
          </div>
          ...
          <div style={{
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(212,144,10,0.85)", margin: "0 0 8px" }}>THE STANDARD</p>
            ...
            <p className="hero-rp-sub" style={{ fontFamily: "'Inter', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.80)", lineHeight: 1.65, margin: "0 0 12px" }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, fontWeight: 700, color: "#d4900a", margin: 0, letterSpacing: "0.02em" }}>
              Costs less than one audit failure
            </p>
          </div>

          {/* Domain label */}
          <p className="hero-rp-label" style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, fontWeight: 700, color: "rgba(212,144,10,0.95)", letterSpacing: "0.14em", textTransform: "uppercase", margin: "0 0 14px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
            {DOMAINS.map((d, i) => (
              <div key={d.num} style={{
                ...
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 15, color: "rgba(212,144,10,0.65)", width: 20, flexShrink: 0 }}>{d.num}</span>
                <span className="hero-domain-name" style={{ fontFamily: "'Inter', sans-serif", fontSize: 18, color: "rgba(255,255,255,0.92)", letterSpacing: "0.01em" }}>{d.name}</span>
              </div>
            ))}
          </div>
