  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? "inset 0 4px 14px rgba(0,0,0,0.75), inset 0 0 0 1px rgba(212,144,10,0.06), inset -4px 0 12px rgba(0,0,0,0.45), 0 12px 40px rgba(212,144,10,0.1)"
          : "inset 0 3px 10px rgba(0,0,0,0.65), inset 0 0 0 1px rgba(0,0,0,0.30), inset -3px 0 8px rgba(0,0,0,0.40)",
      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <FadeIn>
          ...
          <p style={{
            ...
            These systems do not fail in isolation.
          </p>
          <p style={{
            fontFamily: "'Inter', sans-serif",
            fontSize: "1rem",
            ...
            Financial pressure forces load decisions below the rate floor. Low-margin loads push drivers past HOS limits. HOS violations trigger roadside inspections. Inspections escalate to audits. Audits expose DQ file gaps. DQ gaps end authority.
          </p>
          <p style={{
            fontFamily: "'Inter', sans-serif",
            fontSize: "1rem",
            ...
            One pillar under pressure cascades through all four. LaunchPath installs them together because that is how they actually break.
          </p>
        </FadeIn>
