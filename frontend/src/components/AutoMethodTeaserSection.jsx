  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "2rem 1.5rem",
        boxShadow: hovered
          ? "inset 0 4px 14px rgba(0,0,0,0.75), inset 0 0 0 1px rgba(212,144,10,0.10), inset -4px 0 10px rgba(0,0,0,0.50), 0 0 20px rgba(212,144,10,0.06)"
          : "inset 0 3px 10px rgba(0,0,0,0.65), inset 0 0 0 1px rgba(0,0,0,0.25), inset -3px 0 8px rgba(0,0,0,0.40)",
        opacity: visible ? 1 : 0,
