    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <section style={{ background: "var(--bg)", padding: "6rem 1.5rem 4rem", borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.728rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(212,144,10,0.65)", marginBottom: "0.75rem" }}>
            {code} — {category}
          </p>

          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.65rem", letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--text-subtle)", marginBottom: "1.5rem" }}>
          ...
          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.728rem", fontWeight: 700, color: "rgba(212,144,10,0.85)", background: "rgba(212,144,10,0.08)", border: "1px solid rgba(212,144,10,0.25)", padding: "0.3rem 0.875rem", letterSpacing: "0.10em", textTransform: "uppercase" }}>
      ...
      <section style={{ background: "var(--bg-2)", borderBottom: "1px solid var(--border)", padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(212,144,10,0.50)", marginBottom: "1.5rem" }}>
            LP-SYS-001 | BRIEF STATUS
          </p>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.05rem", color: "var(--text-muted)", lineHeight: 1.85, marginBottom: "2rem", maxWidth: 600 }}>
          ...
          <div style={{ borderLeft: "2px solid rgba(212,144,10,0.35)", paddingLeft: "1.25rem", paddingTop: "1rem", paddingBottom: "1rem", background: "rgba(212,144,10,0.04)", marginBottom: "2.5rem" }}>
            <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.65rem", letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(212,144,10,0.60)", marginBottom: "0.5rem" }}>
              In this brief
            </p>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.95rem", color: "var(--text-muted)", lineHeight: 1.75, margin: 0 }}>
          ...
          <Link
            to="/knowledge-center"
            style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", fontWeight: 600, color: "rgba(212,144,10,0.80)", textDecoration: "none", letterSpacing: "0.04em", borderBottom: "1px solid rgba(212,144,10,0.25)", paddingBottom: "1px" }}
          >
