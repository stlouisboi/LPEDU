        ...
        return (
          <div key={row.label} style={{ marginBottom: "0.875rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.3rem" }}>
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.875rem", color: "rgba(255,255,255,0.75)" }}>{row.label}</span>
...
export default function REACHAssessmentWidget({ onEmailCaptured }) {
  ...
  if (phase === "intro") return (
    <div style={box}>
      ...
      <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.875rem", color: "rgba(255,255,255,0.60)", lineHeight: 1.7, marginBottom: "2rem", maxWidth: 500 }}>
  ...
  if (phase === "questions" && currentQ < 14) return (
    <div style={box}>
      ...
      <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.784rem", color: "rgba(255,255,255,0.45)" }}>
  ...
  if (phase === "open") return (
    <div style={box}>
      ...
      <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.784rem", color: "rgba(255,255,255,0.45)", marginTop: "0.75rem" }}>Question 15 of 15</p>
    </div>
  );
  ...
  if (phase === "results" && cfg && scores) return (
    <div style={box}>
      ...
      <div style={{ display: "inline-block", border: `1px solid ${cfg.color}`, padding: "0.35rem 0.875rem", marginBottom: "1.5rem" }}>
        <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: "0.784rem", letterSpacing: "0.16em", textTransform: "uppercase", color: cfg.color, margin: 0 }}>
          {cfg.label}
        </p>
      </div>
      ...
      <ul style={{ listStyle: "none", padding: 0, marginBottom: "2rem" }}>
        {cfg.bullets.map((b, i) => (
          <li key={i} style={{ display: "flex", gap: "0.625rem", marginBottom: "0.625rem", alignItems: "flex-start" }}>
            ...
            <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.925rem", color: "rgba(255,255,255,0.80)", lineHeight: 1.7 }}>{b}</span>
          </li>
        ))}
      </ul>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "1.75rem", marginBottom: "2rem" }}>
        ...
        <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "0.616rem", color: "rgba(255,255,255,0.45)", marginTop: "0.5rem" }}>
      ...
      {!submitted ? (
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "1.75rem" }}>
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.98rem", color: "rgba(255,255,255,0.75)", lineHeight: 1.7, marginBottom: "1.25rem", maxWidth: 460 }}>
          ...
          <form onSubmit={handleEmailSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.625rem", maxWidth: 420 }}>
            <input
              ...
              style={{
                padding: "0.875rem 1.125rem", fontFamily: "'Inter', sans-serif", fontSize: "0.98rem",
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.784rem", color: "rgba(255,255,255,0.50)", marginTop: "0.75rem", fontStyle: "italic" }}>
