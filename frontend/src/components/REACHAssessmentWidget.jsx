...
export default function REACHAssessmentWidget({ onEmailCaptured }) {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    setTimeout(() => {
      router.push(`/ground-0-complete?result=${result}`);
    }, 1800);
  };
  ...
  if (phase === "questions" && currentQ < 14) return (
    <div style={box}>
      ...
      <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 600, fontSize: "clamp(1rem, 2vw, 1.2rem)", color: "#FFFFFF", lineHeight: 1.55, marginBottom: "2rem", maxWidth: 520 }}>
  ...
  if (phase === "insight" && insightIdx !== null) return (
    <div style={box}>
      <div style={{ borderLeft: "2px solid #d4900a", paddingLeft: "1.25rem", maxWidth: 460 }}>
        <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontSize: "1.1rem", color: "rgba(255,255,255,0.85)", lineHeight: 1.8, fontStyle: "italic" }}>
  ...
  if (phase === "open") return (
    <div style={box}>
      ...
      <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 600, fontSize: "clamp(1rem, 2vw, 1.2rem)", color: "#FFFFFF", lineHeight: 1.55, marginBottom: "1.75rem", maxWidth: 520 }}>
  ...
  if (phase === "analyzing") return (
    <div style={{ ...box, textAlign: "center", paddingTop: "2.5rem" }}>
      <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "#FFFFFF", marginBottom: "2rem" }}>
  ...
  if (phase === "results" && cfg && scores) return (
    <div style={box}>
      ...
      <h3 style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.12rem, 2.5vw, 1.5rem)", color: "#FFFFFF", lineHeight: 1.3, marginBottom: "1.25rem", maxWidth: 500 }}>
        {cfg.headline}
      </h3>
