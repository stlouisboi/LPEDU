      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          >
            ...
            <text x="400" y="245" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="10" fontWeight="700" fill="#f0f4f8">CARRIER</text>
            ...
            <text x="400" y="92" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Authority Protection</text>
            ...
            <text x="696" y="247" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Insurance</text>
            <text x="696" y="261" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Continuity</text>
            ...
            <text x="400" y="403" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Compliance Backbone</text>
            ...
            <text x="104" y="247" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Cash-Flow</text>
            <text x="104" y="261" textAnchor="middle" fontFamily="'Manrope', sans-serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Oxygen</text>
