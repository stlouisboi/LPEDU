      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          >
            ...
            {/* Hub label */}
            <text x="400" y="234" textAnchor="middle" fontFamily="'Inter', sans-serif" fontSize="7" fill="#8A96A3" letterSpacing="1.5">THE</text>
            <text x="400" y="245" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="10" fontWeight="700" fill="#f0f4f8">CARRIER</text>
            <text x="400" y="258" textAnchor="middle" fontFamily="'Inter', sans-serif" fontSize="6.5" fill="#E8590F" letterSpacing="1">● PROTECTED</text>
            ...
            <text x="400" y="76" textAnchor="middle" fontFamily="'Inter', sans-serif" fontSize="7.5" fill="#8A96A3" letterSpacing="1.5">NODE-01</text>
            <text x="400" y="92" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Authority Protection</text>
            ...
            <text x="696" y="231" textAnchor="middle" fontFamily="'Inter', sans-serif" fontSize="7.5" fill="#8A96A3" letterSpacing="1.5">NODE-02</text>
            <text x="696" y="247" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Insurance</text>
            <text x="696" y="261" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Continuity</text>
            ...
            <text x="400" y="387" textAnchor="middle" fontFamily="'Inter', sans-serif" fontSize="7.5" fill="#8A96A3" letterSpacing="1.5">NODE-03</text>
            <text x="400" y="403" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Compliance Backbone</text>
            ...
            <text x="104" y="231" textAnchor="middle" fontFamily="'Inter', sans-serif" fontSize="7.5" fill="#8A96A3" letterSpacing="1.5">NODE-04</text>
            <text x="104" y="247" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Cash-Flow</text>
            <text x="104" y="261" textAnchor="middle" fontFamily="'Newsreader', 'Playfair Display', serif" fontSize="11.5" fontWeight="700" fill="#f0f4f8" letterSpacing="-0.3">Oxygen</text>
            <circle cx="160" cy="231" r="3" fill="#E8590F" />

            {/* ── Status bar bottom ── */}
            <line x1="0" y1="462" x2="800" y2="462" stroke="#1e293b" strokeWidth="1" />
            <text x="20" y="474" fontFamily="'Inter', sans-serif" fontSize="7" fill="#4a5568" letterSpacing="1">LAUNCHPATH OPERATING STANDARD</text>
            <text x="780" y="474" textAnchor="end" fontFamily="'Inter', sans-serif" fontSize="7" fill="#4a5568" letterSpacing="1">49 CFR PARTS 382 · 385 · 387 · 395 · 396</text>
          </svg>
        </div>
