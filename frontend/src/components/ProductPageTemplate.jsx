...
export default function ProductPageTemplate({
  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      setBuyState("idle");
      setBuyError("Something went wrong. Please try again or contact support@launchpathedu.com.");
    }
  };
      ...
      <section style={{ background: "#0b1628", borderBottom: `3px solid ${gold}`, padding: "72px 24px 56px" }}>
        <div style={{ maxWidth: hasVisual ? 1100 : 820, margin: "0 auto" }}>
          <FadeIn>
            <div style={{
              display: "grid",
              gridTemplateColumns: hasVisual ? "1fr 400px" : "1fr",
              gap: "3rem",
              alignItems: "center",
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "2rem", flexWrap: "wrap" }}>
                  ...
                  <button
                    ...
                    onMouseLeave={e => { if (!isLoading) e.currentTarget.style.background = isLoading ? "rgba(212,144,10,0.5)" : gold; }}
                  >
                    {isLoading
