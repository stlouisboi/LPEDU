  ...
  return (
    <section data-testid="cl-standard-gate" style={{ background: NAVY, borderTop: `1px solid rgba(250,248,244,0.08)`, borderBottom: `1px solid rgba(250,248,244,0.08)`, padding: '3.5rem 1.5rem' }}>
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        ...
        <p style={{ fontFamily: SANS, fontSize: '0.95rem', color: 'rgba(250,248,244,0.55)', lineHeight: 1.8, marginBottom: '2rem', maxWidth: 560 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', maxWidth: 340 }}>
          <Link
            ...
            style={{ fontFamily: MONO, fontWeight: 700, fontSize: 10, letterSpacing: '0.14em', textTransform: 'uppercase', background: GOLD, color: '#FAF8F4', padding: '1.1rem 2rem', textDecoration: 'none', textAlign: 'center', borderRadius: 0, display: 'block' }}>
            BEGIN GROUND 0 →
          </Link>
