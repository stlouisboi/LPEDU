      ...
      <style>{`
        ...
        @media print {
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          ...
          .print-h1 { font-family: 'Playfair Display', serif; font-size: 2rem; font-weight: 700; letter-spacing: -0.02em; color: #0a0a0a; margin-bottom: 0.75rem; line-height: 1.1; }
          ...
          .print-h2 { font-family: 'Playfair Display', serif; font-size: 1.35rem; font-weight: 700; color: #0a0a0a; margin: 0; }
          ...
          .print-h3 { font-family: 'Playfair Display', serif; font-size: 0.9rem; font-weight: 700; color: #111; margin: 0; }
