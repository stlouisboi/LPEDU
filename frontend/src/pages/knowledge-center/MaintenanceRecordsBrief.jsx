    ...
    <div className="content-page" style={{ background: "var(--bg)", minHeight: "100vh" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {DVIR_STEPS.map((s, i) => (
              <div key={s.num} style={{
                ...
                <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.762rem", color: "var(--text-subtle)", paddingTop: "0.3rem", letterSpacing: "0.05em" }}>{s.num}</span>
                <div>
                  <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "var(--text)", marginBottom: "0.4rem" }}>{s.title}</h3>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "1rem", color: "var(--text-muted)", lineHeight: 1.75 }}>{s.detail}</p>
                </div>
              </div>
            ))}
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "5rem 1.5rem 3rem" }}>
        <div style={{ marginBottom: "4.5rem" }}>
          ...
          {[
            ...
            <div key={i} style={{ display: "flex", gap: "0.875rem", alignItems: "flex-start", marginBottom: "0.625rem" }}>
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.857rem", color: "var(--orange)", marginTop: "0.3rem", flexShrink: 0 }}>—</span>
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "1rem", color: "var(--text-muted)", lineHeight: 1.75 }}>{item}</span>
            </div>
          ))}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", marginTop: "2.5rem" }} className="behaviors-grid">
            {[
              ...
              <div key={block.period} style={{ background: "var(--bg-2)", padding: "1.75rem", border: "1px solid var(--border)" }}>
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.762rem", letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--orange)", marginBottom: "1rem" }}>{block.period}</p>
                {block.items.map((item, i) => (
      ...
      <section data-testid="unit-file-index" className="audit-binder-section" style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.762rem", color: "var(--text-subtle)", letterSpacing: "0.08em", marginBottom: "1.25rem" }}>
