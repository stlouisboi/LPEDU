...
function Body({ children, style = {} }) {
  return (
    <p style={{
      fontFamily: "'Atkinson Hyperlegible', sans-serif", fontSize: "1.12rem", color: "var(--text-muted)",
...
function Callout({ label, children }) {
  return (
    <div style={{
      ...
      {label && (
        <p style={{
          fontFamily: "'IBM Plex Mono', monospace", fontSize: "0.728rem", letterSpacing: "0.14em",
    ...
    <div className="content-page" style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <section data-testid="article-hero" style={{ background: "var(--bg)", padding: "6rem 1.5rem 4rem", borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <Link to="/knowledge-center" style={{
            fontFamily: "'Atkinson Hyperlegible', sans-serif", fontSize: "0.84rem", color: "var(--text-subtle)",
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "1rem" }}>
            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "0.806rem", color: "var(--text-subtle)", letterSpacing: "0.06em" }}>14–16 minute brief</span>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "5rem 1.5rem 3rem" }}>
        ...
        <div style={{ marginBottom: "4.5rem" }}>
          ...
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "var(--text)", marginBottom: "0.75rem" }}>Minimum financial responsibility and Part 387</h3>
          <Body>
          ...
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "var(--text)", marginBottom: "0.75rem", marginTop: "2rem" }}>BMC-91/BMC-91X filings: how your authority comes alive</h3>
          <Body>
          ...
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "var(--text)", marginBottom: "0.75rem", marginTop: "2rem" }}>MCS-90: what it guarantees — and what it doesn't</h3>
          <Body>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "5rem 1.5rem 3rem" }}>
        <div style={{ marginBottom: "4.5rem" }}>
          ...
          <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "var(--text)", marginBottom: "0.75rem", marginTop: "1rem" }}>Quarterly behaviors</h3>
          <BulletList items={[
