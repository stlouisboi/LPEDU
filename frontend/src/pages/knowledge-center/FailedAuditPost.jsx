    ...
    <div className="content-page" style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <div style={{ background: "var(--bg-2)", borderBottom: `3px solid ${gold}`, padding: "5rem 1.5rem 4rem" }}>
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "var(--text-2xl)", letterSpacing: "-0.02em", color: "var(--text)", lineHeight: 1.1, marginBottom: "1.25rem" }}>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "4rem 1.5rem" }}>
        {SECTIONS.map((section, i) => (
          <div key={i} style={{ marginBottom: "3rem" }}>
            <h2 style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "var(--text-xl)", color: "#0b1628", letterSpacing: "-0.01em", lineHeight: 1.2, marginBottom: "1.25rem", paddingBottom: "0.6rem", borderBottom: "1px solid rgba(212,144,10,0.15)" }}>
              {section.heading}
            </h2>
            {section.body.split("\n\n").map((para, j) => (
        ...
        <div style={{ textAlign: "center", padding: "3rem 2rem", background: "var(--bg-2)", border: "1px solid rgba(13,27,48,0.07)" }}>
          ...
          <Link to="/reach-diagnostic" data-testid="article-reach-cta"
