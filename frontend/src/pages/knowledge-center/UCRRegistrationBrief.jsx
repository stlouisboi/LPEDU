    ...
    <div className="content-page" style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <section data-testid="article-hero" style={{ background: "var(--bg)", padding: "6rem 1.5rem 4rem", borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "1rem" }}>
            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "0.806rem", color: "var(--text-subtle)", letterSpacing: "0.06em" }}>8-minute brief</span>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "5rem 1.5rem" }}>
        <div data-testid="article-cta" style={{ borderTop: "1px solid var(--border)", paddingTop: "3.5rem" }}>
          <p style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif", fontSize: "0.728rem", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--text-subtle)", marginBottom: "1rem" }}>What Happens Next</p>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", background: "#000F1F", padding: "2rem 2.5rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1.5rem", flexWrap: "wrap" }}>
          <p style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif", fontSize: "0.84rem", color: "rgba(255,255,255,0.5)", lineHeight: 1.6 }}>
          ...
          <a href="/operating-standard" style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif", fontSize: "0.728rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(212,144,10,0.7)", textDecoration: "none", whiteSpace: "nowrap" }}>
