    ...
    <div style={{ background: navy, minHeight: "100vh", color: "#f4f7fb" }}>
      ...
      <div style={{ background: navy, borderBottom: "1px solid rgba(255,255,255,0.07)", padding: "5rem 2rem 4rem" }}>
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          <FadeIn>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(2rem, 4vw, 3rem)", color: "#FFFFFF", lineHeight: 1.15, letterSpacing: "-0.02em", marginBottom: "1.25rem" }}>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "4rem 2rem 6rem" }}>
        ...
        <FadeIn>
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.2rem, 2.5vw, 1.65rem)", color: "#FFFFFF", lineHeight: 1.25, marginBottom: "0.75rem" }}>
        ...
        <FadeIn delay={30}>
          <div style={{ background: darkCard, border: "1px solid rgba(255,255,255,0.07)", padding: "2.5rem 2.75rem", marginBottom: "4rem" }}>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.1rem, 2.2vw, 1.5rem)", color: "#FFFFFF", lineHeight: 1.25, marginBottom: "1rem" }}>
