  ...
  if (phase === "landing") return wrap(
    <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: "4rem", alignItems: "start" }} className="readiness-grid">
      <div>
        ...
        >
          Take the REACH Diagnostic <ArrowRight size={15} weight="bold" />
        </button>
      ...
      <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "2rem", animation: "heroEnter 0.5s ease both" }}>
          <span style={{
            ...
            fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 800,
            fontSize: "2rem", letterSpacing: "0.08em",
            padding: "0.5rem 1.5rem",
          }}>{result}</span>
          <div>
            <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.25rem", color: "var(--text)", lineHeight: 1.2 }}>{r.headline}</p>
