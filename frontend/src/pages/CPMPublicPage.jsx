  ...
  return (
    <div style={{ background: "#F0F2F4", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "5rem 1.5rem 6rem" }}>
        ...
        <h1 style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 800, fontSize: "clamp(2rem, 4vw, 3.25rem)", color: "#0b1628", letterSpacing: "-0.025em", marginBottom: "0.75rem" }}>
