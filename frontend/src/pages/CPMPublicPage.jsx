  ...
  return (
    <div style={{ background: "#F0F2F4", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "5rem 1.5rem 6rem" }}>
        <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.672rem", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#d4900a", marginBottom: "1.25rem" }}>
        ...
        <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "1.1rem", color: "rgba(0,34,68,0.62)", lineHeight: 1.75, maxWidth: 540, marginBottom: "3.5rem" }}>
