  ...
  return (
    <div data-testid="load-verdict-card" style={{ background: c.bg, border: `2px solid ${c.border}`, padding: "28px", marginBottom: 12 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 16 }}>
        ...
        <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 20, color: c.color, letterSpacing: "-0.01em" }}>
          {c.headline}
        </span>
      </div>
    ...
    <div style={{ background: BG, minHeight: "100vh" }}>
      ...
      <div style={{ background: NAVY, borderBottom: "1px solid rgba(212,144,10,0.20)" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "4rem 1.5rem 3rem" }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.75rem, 4vw, 2.5rem)", color: "#FFFFFF", letterSpacing: "-0.025em", marginBottom: 10 }}>
        ...
        <AccessGate>
          ...
          <div style={{ background: "#FFFFFF", border: "1px solid rgba(11,22,40,0.10)", marginBottom: 12 }}>
            <div style={{ padding: "18px 24px", borderBottom: "1px solid rgba(11,22,40,0.07)" }}>
              ...
              <p style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: 18, color: NAVY, margin: 0 }}>Load Rate & Miles</p>
            </div>
