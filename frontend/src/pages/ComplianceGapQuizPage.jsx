      ...
      <div style={{ background: navy, borderBottom: "1px solid rgba(255,255,255,0.07)", padding: "5rem 2rem 4rem" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <FadeIn>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.75rem, 3.5vw, 2.6rem)", color: "#FFFFFF", lineHeight: 1.15, letterSpacing: "-0.02em", marginBottom: "1.1rem" }}>
        ...
        {phase === "results" && (
          <FadeIn>
            ...
            <div style={{ marginBottom: "2.5rem" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.4rem, 3vw, 2rem)", color: "#FFFFFF", lineHeight: 1.2, marginBottom: "0.75rem" }}>
                {gaps.length === 0
            ...
            <div style={{ background: darkCard, borderLeft: `3px solid ${gold}`, padding: "2.5rem 2.75rem", marginBottom: "2rem" }}>
              <p style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1rem, 2vw, 1.3rem)", color: "#FFFFFF", lineHeight: 1.3, marginBottom: "0.875rem" }}>
                {gaps.length === 0
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", color: "rgba(255,255,255,0.55)", lineHeight: 1.75, maxWidth: 480, marginBottom: "1.75rem" }}>
                {gaps.length === 0
                  ? "Ground 0 walks you through each compliance domain and confirms your systems are correctly installed — not just documented."
                  : `Ground 0 identifies the exact condition of each missing system in your operation and shows you the installation sequence. It takes under 90 minutes and is free.`}
              </p>
              <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                <Link
                  to="/portal"
