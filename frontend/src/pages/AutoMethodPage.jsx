    ...
    <div style={{ fontFamily: SANS, background: midBg, minHeight: "100vh", color: "#FFFFFF" }}>
      ...
      <div style={{ padding: "72px 24px", borderBottom: `1px solid ${BORDER}` }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div className="schematic-grid" style={{ padding: "1px", background: `rgba(197,160,89,0.15)`, position: "relative" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1px" }} className="auto-strip">
              {[
                { v: "A", dir: "AROUND", sub: "Insurance\nExposure",      tag: "VEC-A-01", cfr: "49 CFR § 387.7" },
                { v: "U", dir: "UNDER",  sub: "Documentation\nFailures",  tag: "VEC-U-01", cfr: "49 CFR § 391.51" },
                { v: "T", dir: "THROUGH",sub: "Operations\nViolations",   tag: "VEC-T-01", cfr: "49 CFR § 395.8" },
                { v: "O", dir: "OVER",   sub: "Financial\nCollapse",      tag: "VEC-O-01", cfr: "49 CFR § 387.9" },
              ].map((item) => (
                <div key={item.v} style={{
                  background: "#001830",
                  padding: "2rem 1.25rem 1.25rem",
                  textAlign: "center",
                  borderTop: "1px solid rgba(197,160,89,0.55)",
                  position: "relative",
                  boxShadow: "inset 4px 4px 10px rgba(0,0,0,0.6), inset -1px -1px 2px rgba(255,255,255,0.05)",
                }}>
                  {/* Machined asset tag — top right */}
                  <div style={{ position: "absolute", top: 8, right: 8 }}>
                    <span className="asset-tag">{item.tag}</span>
                  </div>
                  <p style={{
                    fontFamily: COND, fontWeight: 700,
                  ...
                  {/* CFR anchor */}
                  <p className="authority-line">REF: {item.cfr}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ── 3. VECTOR THREAT MAP ────────────────────────────────── */}
      <div style={{ background: "#001830", padding: "72px 24px", borderBottom: `1px solid ${BORDER}` }}>
        <div style={{ maxWidth: 920, margin: "0 auto" }}>
          <p style={sectionLabel}>LP-RISK-001 | VECTOR THREAT ANALYSIS</p>
          ...
          <div className="threat-map-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "rgba(197,160,89,0.15)" }}>
            {[
              {
                v: "A", dir: "AROUND", threat: "Insurance Exposure",
                level: "HIGH", levelColor: "#f59e0b",
                range: "$25K–$250K+",
                rangeNote: "uninsured liability per incident",
                items: [
              ...
              {
                v: "U", dir: "UNDER", threat: "Documentation Failures",
                level: "CRITICAL", levelColor: "#ef4444",
                range: "$5K–$375K",
                rangeNote: "in fines across DQ file violations",
                items: [
              ...
              {
                v: "T", dir: "THROUGH", threat: "Operations Violations",
                level: "HIGH", levelColor: "#f59e0b",
                range: "$1K–$110K",
                rangeNote: "per HOS cycle, compounding",
                items: [
              ...
              {
                v: "O", dir: "OVER", threat: "Financial Collapse",
                level: "CRITICAL", levelColor: "#ef4444",
                range: "$15K–$80K",
                rangeNote: "first-year remediation + insurance delta",
                items: [
              ...
              >
                ...
                <div style={{ position: "absolute", top: 10, right: 10 }}>
                  <span className="asset-tag">VEC-{t.v}-01 | RISK</span>
                </div>

                {/* Vector + Risk level */}
                <div style={{ display: "flex", alignItems: "flex-end", gap: "0.875rem", marginBottom: "0.875rem" }}>
                  <span style={{ fontFamily: COND, fontWeight: 800, fontSize: "2.5rem", color: gold, lineHeight: 1, letterSpacing: "-0.02em" }}>{t.v}</span>
                  <div>
                    <p style={{ fontFamily: MONO, fontSize: "0.714rem", fontWeight: 700, letterSpacing: "0.12em", color: "#fff", marginBottom: 4 }}>{t.dir}</p>
                    <span style={{ fontFamily: "'JetBrains Mono','IBM Plex Mono',monospace", fontSize: 9, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: t.levelColor, background: `${t.levelColor}18`, border: `1px solid ${t.levelColor}55`, padding: "2px 7px", borderRadius: 2 }}>
                      {t.level}
                    </span>
                  </div>
                </div>
                ...
                {/* CFR authority */}
                <p className="authority-line">AUTHORITY: {t.cfr}</p>
              </div>
            ))}
          </div>

          {/* Total exposure callout */}
          <div style={{ marginTop: "1px", background: "#001020", border: "1px solid rgba(197,160,89,0.25)", padding: "1.5rem 2rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1.25rem", boxShadow: "inset 4px 4px 10px rgba(0,0,0,0.5)" }}>
            <div>
            ...
            <Link
              ...
              style={{ fontFamily: SANS, fontWeight: 700, fontSize: "0.857rem", letterSpacing: "0.08em", textTransform: "uppercase", background: gold, color: "#001830", padding: "0.875rem 1.75rem", textDecoration: "none", flexShrink: 0, display: "inline-block" }}
            >
      ...
      <div style={{ padding: "80px 24px", borderBottom: `1px solid ${BORDER}` }}>
        <div style={{ maxWidth: 820, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.62)", lineHeight: 1.85, maxWidth: 580, marginBottom: "1.5rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", color: "rgba(255,255,255,0.42)", lineHeight: 1.85, maxWidth: 580, marginBottom: "3rem", fontStyle: "italic" }}>
