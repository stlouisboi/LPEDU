      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "64px 24px" }}>
              ...
              <div key={i} style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: "1rem", marginBottom: "0.5rem" }}>
                    ...
                    <span style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.1rem", color: "#FFFFFF" }}>{tier.label}</span>
                  </div>
        ...
        <FadeIn delay={90}>
          <div style={{
            ...
            <h2 style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.5rem", color: "#FFFFFF", marginBottom: "0.75rem" }}>New Carrier Document System — $499</h2>
        ...
        <FadeIn delay={160}>
          ...
          <h2 style={{
            fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.4rem",
              ...
              <tfoot>
                <tr>
                  ...
                  <td style={{
                    ...
                    <Link to="/reach-diagnostic" style={{
                      fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: "0.762rem",
                      letterSpacing: "0.08em", textTransform: "uppercase",
