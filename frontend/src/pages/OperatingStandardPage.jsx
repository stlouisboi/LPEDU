    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#0d1c30", minHeight: "100vh", color: "#FFFFFF" }}>
      ...
      <div style={{ background: "#000F1F", borderBottom: "1px solid rgba(212,144,10,0.2)", padding: "100px 24px 80px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ borderLeft: "2px solid rgba(212,144,10,0.4)", paddingLeft: "1.5rem" }}>
            <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "#d4900a", marginBottom: "0.4rem" }}>
              Accuracy Over Hype.
            </p>
            <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "rgba(212,144,10,0.90)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "rgba(255,255,255,0.08)" }} className="pillars-grid">
            {PILLARS.map((p, i) => (
              <div key={i} style={{ background: "#0b1628", padding: "2.5rem 2rem" }}>
                ...
                <p style={{ fontFamily: "'Newsreader', 'Playfair Display', serif", fontWeight: 700, fontSize: "1.12rem", color: "#FFFFFF", marginBottom: "0.875rem" }}>
                  {p.label}
                </p>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "2.5rem 1.5rem" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          <div>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.714rem", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(212,144,10,0.65)", marginBottom: "0.35rem" }}>
              NEXT IN THE FRAMEWORK
            </p>
