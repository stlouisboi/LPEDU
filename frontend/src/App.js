...
import FinancialRunwayBrief from "./pages/knowledge-center/FinancialRunwayBrief";
...
import AdminAuditWindowsPage from "./pages/AdminAuditWindowsPage";
...
import LaunchPathSalesPage from "./pages/LaunchPathSalesPage";
...
function AppRouter() {
  ...
  return (
    <Routes>
      ...
      <Route path="/launchpath-standard" element={<Navigate to="/program" replace />} />
      ...
      <Route path="/admin/audit-windows" element={<AdminAuditWindowsPage />} />
      ...
      <Route path="/knowledge-center/lp-brf-12" element={<FinancialRunwayBrief />} />
      ...
      <Route path="/bundle" element={<BundleSalesPage />} />
      <Route path="/document-system-bundle" element={<Navigate to="/bundle" replace />} />
      <Route path="/new-carrier-document-system" element={<Navigate to="/bundle" replace />} />
      ...
      <Route path="/program" element={<LaunchPathSalesPage />} />
