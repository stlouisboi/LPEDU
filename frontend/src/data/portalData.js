export const CURRICULUM = [
  ...
  { id: "module-3", code: "MODULE 3", label: "The 16 Deadly Sins",           locked: true,  type: "core",       typeLabel: "CORE IMPLEMENTATION",    lessonCount: 12  },
...
export const MODULE_OVERVIEWS = {
  ...
  "module-3": {
    code: "MOD-3", title: "The 16 Deadly Sins", lessonCount: 12, duration: "~165 min",
    description: "The Exposure & Refuge framework governs this module. Each of the 16 documented FMCSA violation categories is presented as an exposure with a corresponding refuge — the system you install to eliminate it permanently. Extended to cover PSP records, driver record management, dispatch liability, and professional refusal language.",
    topics: ["Introduction — What the 16 Sins Actually Represent", "Drug & Alcohol Exposure (Sins 1–5) — testing failures and program gaps", "Driver Qualification Exposure (Sins 6–9) — DQF deficiencies at audit", "Insurance & Financial Exposure (Sins 10–11) — lapses and coverage failures", "Vehicle Maintenance Exposure (Sins 12, 14, 15) — inspection and record failures", "Hours of Service Exposure (Sins 13, 16) — log violations and ELD gaps", "The Complete Exposure Map — all 16 patterns in sequence", "From Exposure to Refuge — what the installation sequence addresses", "What a PSP Is — the FMCSA pre-employment screening record and what it contains", "What Goes on Your Record — inspections, violations, and crash data that follow carrier and driver", "The Dispatch Permission Trap — how dispatch decisions create carrier liability", "Decision Discipline & Refusal Language — the framework and language for documented refusal"],
  },
  "module-4": {
