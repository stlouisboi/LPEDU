...
export default function Page() {
  return (
    <>
      <Head>
        <title>LaunchPath Standard | 90-Day FMCSA Installation</title>
        ...
        <meta property="og:title" content="LaunchPath Standard | 90-Day FMCSA Installation" />
        ...
        <meta name="twitter:title" content="LaunchPath Standard | 90-Day FMCSA Installation" />
