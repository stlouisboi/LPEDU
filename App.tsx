        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-text-muted dark:text-text-dark-muted text-sm font-bold">
              ...
              <li><Link to="/learning-path" className="hover:text-authority-blue transition-colors">Implementation Roadmap</Link></li>
  ...
  useEffect(() => {
    ...
    try {
      const unsub = onSnapshot(doc(db, "settings", "general"), (snap) => {
        ...
        console.warn("LaunchPath Settings Sync failed (using local fallback). Verify Firestore rules.", err.message);
        // Ensure app still loads with initial settings on permission failure
