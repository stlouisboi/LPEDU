    ...
    <div className="animate-in fade-in duration-700 relative overflow-x-hidden bg-white dark:bg-primary-dark font-sans text-authority-blue leading-relaxed selection:bg-signal-gold/20">
      ...
      <section className="relative pt-20 pb-16 md:pt-32 md:pb-24 lg:pt-40 bg-white dark:bg-primary-dark overflow-hidden">
        ...
        <div className="max-w-[1700px] mx-auto px-6 sm:px-12 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-10 md:space-y-12 animate-reveal-up">
            <div className="inline-flex items-center space-x-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 px-5 py-2.5 rounded-full">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.4em] text-authority-blue dark:text-white">Institutional FMCSA Standard</span>
            </div>
            ...
            <div className="max-w-xl border-l-[8px] sm:border-l-[12px] border-authority-blue dark:border-signal-gold pl-6 sm:pl-10 py-2 sm:py-4">
              <p className="text-[18px] sm:text-[22px] md:text-2xl font-bold text-slate-800 dark:text-slate-300 leading-[1.6]">
          ...
          <aside className="lg:col-span-5 animate-reveal-up w-full lg:sticky lg:top-40" style={{ animationDelay: '0.2s' }}>
            <div className="bg-white dark:bg-surface-dark p-8 sm:p-12 md:p-16 rounded-[3rem] sm:rounded-[4rem] shadow-[0_60px_120px_-30px_rgba(30,58,95,0.15)] border border-slate-100 dark:border-white/5 relative overflow-hidden group min-h-[500px] lg:min-h-[700px] flex flex-col">
              ...
              <div className="relative z-10 flex flex-col flex-grow">
                {scanState === 'idle' ? (
                  <>
                    <header className="mb-10 sm:mb-16 mt-16 sm:mt-20">
                         <h3 className="text-[3.5rem] sm:text-[5rem] md:text-[6.5rem] font-black font-serif uppercase tracking-tighter text-authority-blue dark:text-white leading-[0.8] drop-shadow-sm">
                           90 DAY <br/>
                           <span className="text-signal-gold italic">RISK MAP</span>
                         </h3>
                         <p className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-400 mt-6 sm:mt-8 border-t border-slate-100 pt-6">Diagnostic Orientation Terminal</p>
                    </header>
                    
                    <form onSubmit={handleRiskMapSubmit} className="space-y-6 sm:space-y-10 flex-grow">
                      <div className="space-y-2 sm:space-y-4">
                        <label className="text-[11px] sm:text-[13px] font-black uppercase tracking-[0.5em] text-slate-400 ml-4">LEGAL ENTITY NAME</label>
                        <input 
                          required 
                          value={formData.firstName}
                          onChange={e => setFormData({...formData, firstName: e.target.value})}
                          className="w-full bg-slate-50 dark:bg-gray-800 border-2 border-slate-100 dark:border-border-dark focus:border-authority-blue dark:focus:border-signal-gold outline-none px-6 py-5 sm:px-10 sm:py-8 rounded-2xl sm:rounded-3xl font-black text-[18px] sm:text-[20px] transition-all text-authority-blue dark:text-white placeholder:text-slate-300 shadow-inner" 
                          placeholder="JANE DOE" 
                        />
                      </div>
                      <div className="space-y-2 sm:space-y-4">
                        <label className="text-[11px] sm:text-[13px] font-black uppercase tracking-[0.5em] text-slate-400 ml-4">REGISTRY EMAIL</label>
                        <input 
                          required 
                          type="email"
                      ...
                      <div className="pt-6 sm:pt-10">
                        <button 
                          type="submit"
                          className="w-full bg-authority-blue text-white py-8 sm:py-10 rounded-2xl sm:rounded-[2.5rem] font-black uppercase tracking-[0.4em] text-[20px] shadow-[0_20px_50px_-10px_rgba(30,58,95,0.4)] hover:bg-steel-blue transition-all active:scale-[0.98] flex items-center justify-center group border-b-[8px] sm:border-b-[12px] border-slate-900"
                        >
                  ...
                  <div className="py-20 text-center space-y-12 animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <div className="space-y-6">
                       <h3 className="text-[28px] font-black text-authority-blue dark:text-white uppercase tracking-widest font-serif italic">
                         {scanState === 'scanning' ? 'Synthesizing Exposure...' : 'Finalizing Registry...'}
                       </h3>
                       <div className="max-w-[350px] mx-auto bg-slate-50 dark:bg-black/40 rounded-3xl p-8 border border-slate-100 dark:border-white/10 font-mono text-[12px] text-authority-blue dark:text-emerald-500 text-left h-48 overflow-hidden relative shadow-inner">
      ...
      <section className="py-24 bg-slate-50 dark:bg-surface-dark border-y border-slate-100 dark:border-border-dark overflow-hidden transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="relative group max-w-[480px] mx-auto lg:mx-0">
                ...
                <div className="bg-authority-blue dark:bg-primary-dark rounded-[3rem] shadow-2xl overflow-hidden relative border-[8px] border-white dark:border-border-dark">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-authority-blue/90 backdrop-blur-md py-6 text-center border-t border-white/10">
                    <p className="text-[12px] font-black text-signal-gold uppercase tracking-[0.4em]">SYSTEM CUSTODIAN</p>
                  </div>
                </div>
                <div className="absolute -bottom-6 -right-6 bg-signal-gold p-6 rounded-2xl shadow-xl border-4 border-white dark:border-surface-dark hidden sm:block z-20 group-hover:rotate-12 transition-transform">
                  <Award className="text-authority-blue" size={40} />
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-12">
              <div>
                <h2 className="text-[13px] font-black uppercase tracking-[0.4em] text-authority-blue dark:text-signal-gold mb-6">FOUNDER & LEAD ADVISOR</h2>
                <h1 className="text-[40px] md:text-[56px] lg:text-[64px] font-black font-serif text-authority-blue dark:text-white leading-tight uppercase tracking-tight">
                  Vince Lawrence.
                </h1>
                <p className="text-[20px] font-bold text-slate-500 dark:text-slate-400 mt-6 leading-[1.6]">
              ...
              <div className="space-y-6">
                {[
                  { icon: <ShieldCheck size={24} />, text: "U.S. NAVY VETERAN" },
                  { icon: <Shield size={24} />, text: "OSHA-CERTIFIED" },
                  { icon: <Briefcase size={24} />, text: "20+ YRS COMPLIANCE" }
                ].map((item, i) => (
                  <div key={i} className="flex items-center space-x-8 bg-white dark:bg-gray-800 px-8 py-6 rounded-[2rem] border border-slate-100 dark:border-border-dark shadow-sm hover:shadow-md hover:border-authority-blue/20 transition-all group cursor-default">
                    <div className="text-signal-gold transition-transform group-hover:scale-110 duration-300">
                      {item.icon}
                    </div>
                    <span className="text-[18px] sm:text-[20px] font-black uppercase tracking-[0.25em] text-authority-blue dark:text-white">
                      {item.text}
                    </span>
                  </div>
                ))}
              ...
              <div className="pt-6">
                <Link to="/about" className="inline-flex items-center space-x-3 text-[14px] font-black uppercase tracking-[0.3em] text-authority-blue dark:text-signal-gold hover:underline group">
      ...
      <section className="py-24 md:py-48 bg-white dark:bg-primary-dark overflow-hidden">
        <div className="max-w-[90%] md:max-w-4xl mx-auto text-center">
          <header className="mb-16 space-y-10">
            ...
            <h2 className="text-[48px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-black font-serif text-authority-blue dark:text-white uppercase tracking-tighter leading-[0.9]">
              I'VE WATCHED THIS <br/><span className="text-red-600 italic">FAIL</span> 200 TIMES.
            </h2>
          </header>

          <div className="space-y-16">
            <div className="space-y-10 text-[20px] md:text-[24px] font-bold text-slate-600 dark:text-slate-300 leading-[1.6] text-left border-l-8 border-slate-200 dark:border-border-dark pl-8 sm:pl-12">
              <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <article className="space-y-10 md:space-y-14">
              <header className="space-y-6">
                <p className="text-[13px] font-black uppercase tracking-[0.6em] text-slate-400">THE STANDARD</p>
                <h2 className="text-[40px] sm:text-[56px] md:text-[64px] lg:text-[72px] font-black font-serif text-authority-blue dark:text-white uppercase tracking-tighter leading-none">
                  ORDER BEFORE <br/><span className="text-signal-gold italic">REVENUE.</span>
                </h2>
              </header>
              <div className="space-y-10 text-[20px] sm:text-[22px] font-bold text-slate-500 dark:text-slate-400 leading-[1.6]">
            ...
            <aside className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
               ...
               >
                  ...
                  <ul className="space-y-6 text-[18px] font-black text-slate-500 leading-relaxed">
                     ...
                     <li className="flex items-center"><XCircle size={24} className="text-red-500 mr-5 shrink-0" /> Waiting for federal audit alerts</li>
               ...
               >
                  ...
                  <ul className="space-y-6 text-[18px] font-black text-white leading-relaxed">
                     ...
                     <li className="flex items-center"><CheckCircle2 size={24} className="text-signal-gold mr-5 shrink-0" /> Permanent audit-ready posture</li>
                     <li className="flex items-center"><CheckCircle2 size={24} className="text-signal-gold mr-5 shrink-0" /> Integrated, defensible record systems</li>
                  </ul>
               </div>
            </aside>
          </div>
      ...
      <section className="py-24 md:py-40 bg-[#0c1a2d] text-white overflow-hidden transition-colors duration-300 relative border-y-[12px] border-authority-blue">
        ...
        <div className="max-w-[1400px] mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            
            <div className="lg:col-span-6 space-y-10">
              <div className="inline-flex items-center space-x-4 bg-red-600/10 border border-red-600/30 px-8 py-3 rounded-full mb-4">
                 <ShieldAlert size={18} className="text-red-500" />
                 <span className="text-[12px] font-black uppercase tracking-[0.5em] text-red-400">ENTRY CRITERIA REQUIRED</span>
              </div>
              <h2 className="text-[40px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-black font-serif uppercase tracking-tighter leading-[0.9]">
                SYSTEM ACCESS <br/><span className="text-red-600 italic">WARNING.</span>
              </h2>
              <div className="h-3 w-48 bg-red-600"></div>
              <p className="text-[20px] sm:text-[24px] md:text-[28px] font-bold text-slate-300 leading-[1.6] max-w-xl">
              ...
              <div className="bg-white/5 border-l-8 border-red-600 p-8 sm:p-12 rounded-r-[3rem] max-w-xl shadow-2xl">
                <p className="text-[18px] sm:text-[20px] text-slate-400 font-medium leading-relaxed italic">
            ...
            <div className="lg:col-span-6 grid grid-cols-1 gap-8">
              ...
              <div className="pt-12">
                <Link to="/readiness" className="w-full bg-red-600 text-white py-10 sm:py-12 rounded-[2.5rem] font-black uppercase tracking-[0.4em] text-[20px] shadow-2xl hover:bg-red-700 transition-all active:scale-95 flex items-center justify-center group border-b-[12px] border-slate-900">
                  <ChevronRight className="mr-4 group-hover:translate-x-2 transition-transform" size={28} />
                  VALIDATE MY ELIGIBILITY
                </Link>
                <p className="text-[11px] text-center text-slate-500 uppercase tracking-[0.3em] mt-8 font-black">
      ...
      {/* 6. THE FOUR PILLARS */}
      <section className="py-24 md:py-40 bg-[#020617] border-b border-white/5 transition-colors duration-300">
        <div className="max-w-[1400px] mx-auto px-6">
          <header className="text-center mb-16 md:mb-32 space-y-8">
             <p className="text-[13px] font-black uppercase tracking-[0.6em] text-slate-400">THE FRAMEWORK</p>
             <h2 className="text-[48px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-black font-serif text-white uppercase tracking-tighter leading-tight">
               THE FOUR <span className="text-signal-gold italic">PILLARS.</span>
             </h2>
             <p className="text-[20px] sm:text-[24px] md:text-[28px] font-bold text-slate-400 max-w-2xl mx-auto leading-relaxed">
               The systems that keep you operating.
             </p>
          </header>

          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
             {[
               ...
               <article key={i} className="bg-white/[0.03] p-10 sm:p-14 md:p-16 rounded-[3.5rem] md:rounded-[4.5rem] border border-white/10 flex flex-col text-center group hover:shadow-[0_40px_100px_-20px_rgba(198,146,42,0.1)] transition-all duration-700 relative overflow-hidden">
                  ...
                  <p className="text-[11px] font-black uppercase tracking-[0.4em] text-signal-gold mb-8 sm:mb-10 opacity-70">{pillar.tagline}</p>
                  <p className="text-[18px] font-bold text-slate-400 leading-[1.6] mb-10 sm:mb-12 flex-grow">
                    {pillar.desc}
                  </p>
                  <Link to={pillar.link} className="inline-flex items-center justify-center space-x-3 text-[13px] font-black uppercase tracking-[0.3em] text-signal-gold hover:text-white transition-all group/btn">
      ...
      <section id="exposure-matrix" className="bg-[#020617] py-24 lg:py-48 border-y border-white/5 transition-colors duration-300 relative overflow-hidden">
        ...
        <div className="max-w-[1600px] mx-auto px-6 relative z-10">
          <header className="text-center mb-16 md:mb-32 lg:mb-40 space-y-12 animate-reveal-up">
             <div className="w-24 h-24 sm:w-32 sm:h-32 bg-red-600/10 text-red-500 rounded-[2.5rem] sm:rounded-[3rem] flex items-center justify-center mx-auto mb-12 shadow-2xl border-4 border-red-500/20">
               <ShieldX size={64} />
             </div>
             <p className="text-[13px] font-black uppercase tracking-[0.8em] text-red-500">THE EXPOSURE TAXONOMY</p>
             <h2 className="text-[48px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-black font-serif text-white uppercase tracking-tighter leading-[0.9]">
               THE 16 DEADLY SINS OF <br/><span className="text-red-600 italic">CARRIER FAILURE.</span>
             </h2>
             <div className="h-2 w-48 bg-red-600/20 mx-auto rounded-full mt-16"></div>
             <p className="text-[20px] sm:text-[24px] md:text-[28px] font-bold text-slate-400 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            {riskDomains.map((domain, domainIdx) => (
              <div key={domainIdx} className="space-y-12 animate-reveal-up" style={{ animationDelay: `${domainIdx * 0.1}s` }}>
                <header className="flex items-center justify-between border-b border-white/10 pb-10">
                   <div className="flex items-center space-x-8">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] font-black text-white/80 uppercase tracking-widest mt-2">{domain.id} // SECURE_ARCHIVE</p>
                      </div>
                   </div>
                   <div className="hidden sm:block text-right">
                      <p className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Active Vectors</p>
                      <p className="text-3xl font-black text-white">0{domain.items.length}</p>
                   </div>
                </header>
      ...
      <section className="py-24 md:py-48 bg-white dark:bg-primary-dark overflow-hidden transition-colors duration-300">
        <div className="max-w-[90%] md:max-w-5xl mx-auto px-6">
          <header className="text-center mb-24 space-y-10">
             <p className="text-[13px] font-black uppercase tracking-[0.6em] text-slate-400">FAQS</p>
             <h2 className="text-[48px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-black font-serif text-authority-blue dark:text-white uppercase tracking-tight leading-none">COMMON <span className="text-signal-gold italic">QUESTIONS.</span></h2>
          </header>
          <div className="space-y-6">
            {[
      ...
      <section className="py-24 md:py-48 bg-[#0c1a2d] text-white overflow-hidden relative transition-colors duration-300">
        ...
        <div className="max-w-[1600px] mx-auto px-6 text-center relative z-10 space-y-16">
           <header className="space-y-10">
              <h2 className="text-[48px] sm:text-[64px] md:text-[80px] lg:text-[100px] font-black font-serif uppercase tracking-tight leading-none">BUILD YOUR CARRIER LIKE A <br/><span className="text-signal-gold italic">CARRIER EXECUTIVE.</span></h2>
              <p className="text-[20px] sm:text-[24px] md:text-[28px] text-slate-300 font-medium max-w-4xl mx-auto leading-[1.6]">You didn't get your authority to hope you don't get audited. You got it to build something that lasts. LaunchPath gives you the infrastructure to operate with discipline.</p>
           </header>
           <div className="flex flex-col sm:flex-row items-center justify-center gap-10 pt-10">
              <Link to="/readiness" className="w-full sm:w-auto bg-signal-gold text-authority-blue px-14 sm:px-20 py-8 sm:py-10 rounded-[2.5rem] font-black uppercase tracking-[0.3em] text-[20px] shadow-2xl hover:bg-white transition-all active:scale-95 flex items-center justify-center group border-b-[12px] border-slate-900">TAKE THE REACH TEST™ <ArrowRight size={28} className="ml-5 group-hover:translate-x-2 transition-transform" /></Link>
              <Link to="/pricing" className="w-full sm:w-auto border-4 border-white/20 px-14 sm:px-20 py-8 sm:py-10 rounded-[2.5rem] font-black uppercase tracking-[0.3em] text-[20px] hover:bg-white/5 transition-all flex items-center justify-center">VIEW ADMISSION PROTOCOL</Link>
           </div>
           <p className="text-[13px] font-black uppercase tracking-[0.5em] text-white/20 pt-24">VETERAN OWNED & OPERATED • ACCURACY OVER HYPE.™</p>
        </div>
      </section>
    </div>
  );
