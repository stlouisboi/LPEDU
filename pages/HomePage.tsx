    ...
    <div className="animate-in fade-in duration-700 relative overflow-x-hidden bg-[#FAF9F6] dark:bg-primary-dark font-sans text-authority-blue leading-relaxed selection:bg-signal-gold/20">
        ...
        <div className="max-w-[1600px] mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8 md:space-y-12 animate-reveal-up">
            <div className="inline-flex items-center space-x-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 px-4 py-2 md:px-5 md:py-2.5 rounded-full">
              ...
              <span className="text-xs md:text-[10px] font-black uppercase tracking-widest md:tracking-[0.4em] text-authority-blue dark:text-white">Institutional FMCSA (Federal Safety) Standard</span>
            </div>
      ...
      <section className="py-24 md:py-48 bg-white dark:bg-primary-dark overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6">
          <header className="text-center mb-16 md:mb-32 space-y-6">
            <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.6em] text-slate-300 dark:text-slate-700">FOUNDATIONAL PURPOSE</p>
            ...
            <aside className="bg-authority-blue dark:bg-surface-dark p-10 md:p-14 rounded-[3.5rem] md:rounded-[5rem] shadow-2xl relative overflow-hidden border-b-[12px] border-slate-900">
              ...
              <div className="relative z-10">
                <header className="flex items-center space-x-4 mb-10">
                   ...
                   <h4 className="text-xs font-black uppercase tracking-widest md:tracking-[0.4em] text-white">THE OPERATING STANDARD</h4>
                </header>
                ...
                <div className="p-8 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm mb-12">
                   <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.4em] text-signal-gold mb-4">// MISSION PARADIGM</p>
                ...
                <footer className="pt-10 border-t border-white/10 space-y-5">
                   <p className="text-xs font-black uppercase tracking-widest text-slate-500">OPERATOR VALUE ALIGNMENT:</p>
                   <div className="flex flex-col space-y-3">
                      {["Long-term operation over fast entry", "Structure over hustle", "Clarity over noise", "Stewardship over shortcuts"].map((v, i) => (
                        <div key={i} className="flex items-center space-x-3">
                           ...
                           <span className="text-xs font-black uppercase tracking-widest text-slate-300">{v}</span>
                        </div>
                      ))}
                   </div>
                </footer>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            ...
            <article className="lg:col-span-6 space-y-10 animate-reveal-up">
              <header className="inline-flex items-center space-x-3 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 px-5 py-2.5 rounded-full shadow-sm">
                ...
                <span className="text-xs font-black uppercase tracking-widest sm:tracking-[0.4em] text-authority-blue dark:text-white">YOUR FIRST 90 DAYS</span>
              </header>
              ...
              <div className="p-8 bg-white dark:bg-surface-dark border-l-[12px] border-signal-gold rounded-r-[3rem] shadow-sm">
                 <p className="text-xs font-black uppercase tracking-widest text-authority-blue dark:text-signal-gold mb-4">SYSTEMIC BOUNDARY</p>
              ...
              <div className="bg-authority-blue dark:bg-surface-dark p-12 rounded-[5rem] border-4 border-white/10 shadow-[0_60px_120px_-40px_rgba(30,58,95,0.4)] relative overflow-hidden flex flex-col items-center justify-center min-h-[600px] group">
                ...
                <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
                   ...
                   <div className="relative z-10 text-center space-y-6">
                      ...
                      <div className="space-y-2">
                        <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.5em] text-slate-400 group-hover:text-white transition-colors">DIAGNOSTIC SCAN ACTIVE</p>
      ...
      <section className="py-24 md:py-32 lg:py-56 bg-white dark:bg-primary-dark transition-colors">
        <div className="max-w-[1400px] mx-auto px-6">
          <header className="text-center mb-16 md:mb-24 space-y-6">
             ...
             <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.5em] text-slate-400">THE OPERATIONAL FRAMEWORK</p>
          </header>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-10 animate-reveal-up">
          <header className="text-center mb-16 md:mb-24 space-y-8">
            <div className="inline-flex items-center space-x-3 bg-red-600 text-white px-8 py-3 rounded-full shadow-xl">
              ...
              <span className="text-xs font-black uppercase tracking-widest sm:tracking-[0.5em]">Registry Warning: Audit Failure Vectors</span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-start">
            <div className="space-y-12">
              <header className="space-y-6">
                ...
                <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.5em] text-slate-400">
                ...
                {modules.map((mod, i) => (
                  <div key={i} className="flex space-x-6">
                    ...
                    <article className="space-y-1">
                      <h4 className="text-xs font-black text-signal-gold uppercase tracking-widest">{mod.n}</h4>
            ...
            <aside className="bg-authority-blue dark:bg-surface-dark p-10 md:p-16 rounded-[4rem] md:rounded-[5rem] shadow-2xl relative overflow-hidden border-b-[12px] border-slate-900 group">
              ...
              <div className="relative z-10 space-y-10">
                <header className="flex items-center space-x-4">
                   <ShieldCheck size={28} className="text-signal-gold" />
                   <h4 className="text-xs font-black uppercase tracking-widest md:tracking-[0.4em] text-white">WHAT YOU WALK AWAY WITH</h4>
                </header>
      ...
      <section className="py-20 md:py-32 lg:py-56 bg-white dark:bg-primary-dark relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          <p className="text-xs font-black uppercase tracking-widest md:tracking-[0.6em] text-slate-300 mb-8 md:mb-12">TECHNICAL READINESS ASSESSMENT</p>
          ...
          <article className="max-w-2xl mx-auto mb-20">
            ...
            <div className="inline-flex items-center px-8 py-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/40 rounded-2xl mb-12">
               ...
               <span className="text-xs font-black uppercase text-amber-800 dark:text-amber-400 tracking-widest leading-none">DIAGNOSTIC ASSESSMENT ONLY — NOT AN IMPLEMENTATION</span>
            </div>
          </article>
            ...
            {[
              ...
              <article key={i} className="flex flex-col items-center p-10 md:p-12 bg-white dark:bg-surface-dark rounded-[3.5rem] md:rounded-[4.5rem] border border-slate-100 dark:border-border-dark text-center group hover:shadow-2xl transition-all">
                ...
                <div className="space-y-3">
                  <p className="text-xs font-black uppercase text-slate-400 tracking-widest md:tracking-[0.5em]">{vector.l}</p>
      ...
      <section className="py-20 lg:py-28 bg-white dark:bg-primary-dark border-t border-slate-100 dark:border-border-dark transition-colors">
        <div className="max-w-6xl mx-auto px-5 sm:px-10 animate-reveal-up">
          <header className="text-center mb-16 space-y-4">
            <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.6em] text-authority-blue dark:text-signal-gold">Integrated Compliance Tools</p>
            ...
            <div className="lg:col-span-8 space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                <div className="inline-flex items-center space-x-3 bg-white/5 border border-white/10 px-5 py-2 rounded-full mx-auto lg:mx-0 shadow-sm">
                  ...
                  <span className="text-xs font-black uppercase tracking-widest sm:tracking-[0.3em] text-white/70">SYSTEM CUSTODIAN</span>
                </div>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 pt-4">
                {[
                  ...
                  <div key={i} className="flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 text-xs font-black uppercase tracking-widest text-white/50 hover:bg-white/10 transition-colors">
                    {badge.icon}
              ...
              <div className="pt-6">
                <Link to="/about" className="inline-flex items-center text-xs font-black uppercase tracking-widest sm:tracking-[0.3em] text-white/60 hover:text-signal-gold transition-colors group">
      ...
      <section className="py-24 md:py-32 lg:py-48 bg-slate-50 dark:bg-primary-dark transition-colors">
        <div className="max-w-7xl mx-auto px-6">
          <header className="text-center mb-16 lg:mb-24 space-y-4">
            <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.5em] text-slate-400">QUALIFICATION PARAMETERS</p>
      ...
      <section className="py-24 lg:py-40 bg-[#F8FAFC] dark:bg-surface-dark transition-colors border-t border-slate-200 dark:border-border-dark">
        <div className="max-w-4xl mx-auto px-5 sm:px-10">
          ...
          <div className="mt-12 text-center">
            <Link to="/faq" className="text-xs font-black uppercase tracking-widest sm:tracking-[0.3em] text-authority-blue dark:text-signal-gold hover:text-signal-gold dark:hover:text-white transition-colors inline-flex items-center space-x-2 group">
      ...
      <section className="py-24 md:py-48 lg:py-64 bg-[#F8F9FA] dark:bg-primary-dark text-center border-t border-slate-50 dark:border-border-dark">
        <div className="max-w-[1400px] mx-auto px-6 space-y-16 md:space-y-24">
          ...
          <nav className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-10">
             <Link to="/readiness" className="w-full sm:w-auto bg-authority-blue text-white px-12 md:px-20 py-7 md:py-10 rounded-[2rem] md:rounded-[3rem] font-black uppercase tracking-widest md:tracking-[0.4em] text-xs md:text-sm hover:bg-steel-blue transition-all shadow-2xl active:scale-95 inline-flex items-center justify-center border-b-[12px] border-slate-900 group">
               APPLY FOR ADMISSION
               <ArrowRight size={20} className="ml-5 group-hover:translate-x-2 transition-transform" />
             </Link>
             <Link to="/about" className="text-xs font-black uppercase tracking-widest md:tracking-[0.3em] hover:text-authority-blue transition-colors">
                Review Program Standard
             </Link>
          </nav>
        </div>
      ...
      <footer className="bg-slate-50 dark:bg-surface-dark py-12 border-t border-slate-100 dark:border-border-dark text-center">
         <p className="text-xs font-black uppercase tracking-widest sm:tracking-[0.8em] text-slate-300 dark:text-slate-600 italic">SYSTEM REGISTRY IDENTIFIER: NC-LP-V4.5 — END OF REPOSITORY BRIEF</p>
      </footer>
