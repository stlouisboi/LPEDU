...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="animate-in fade-in duration-700 relative overflow-x-hidden bg-white dark:bg-primary-dark font-sans text-authority-blue">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <div className="text-xl lg:text-[22px] text-white/80 mb-12 leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium">
                <p>LaunchPath is a compliance-first operating standard for new and early-stage motor carriers. We help carriers build the systems FMCSA expects to see — before enforcement forces the issue.</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-6 space-y-8">
              ...
              <div className="space-y-6 text-lg text-text-muted dark:text-text-dark-muted font-medium leading-relaxed max-w-xl">
                <p>Most enforcement failures are not caused by lack of effort — they are caused by missing systems. During the first 90 days, regulators and insurers monitor your data for documentation gaps known as <span className="text-authority-blue dark:text-white font-bold">“the 16 Deadly Sins.”</span></p>
                <p>These exposure points are the primary triggers behind unscheduled federal audits and sudden insurance cancellations. LaunchPath builds the necessary operational infrastructure before these gaps become violations.</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 bg-slate-50 dark:bg-surface-dark p-10 md:p-12 rounded-[3.5rem] border border-slate-200 dark:border-border-dark shadow-sm">
              ...
              <p className="text-base text-text-muted dark:text-text-dark-muted font-medium leading-relaxed mb-10">
                To maintain insurance continuity and pass federal scrutiny, you must move from accidental exposure to active protection. The <span className="text-signal-gold font-bold italic">Four Pillars</span> are the structured documentation systems auditors expect to see:
              </p>
      ...
      <section className="py-32 bg-authority-blue relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-black font-serif text-white uppercase tracking-tight mb-6 leading-tight">
            See Your Exposure Before the <br/><span className="text-signal-gold italic font-serif">Audit Letter Arrives.</span>
          </h2>
          <p className="text-xl text-white/80 font-medium mb-12 max-w-3xl mx-auto leading-relaxed">
            FMCSA audits are procedural. Exposure exists where systems are absent. The <span className="text-white font-bold">First 90 Days Risk Map™</span> is a diagnostic tool that provides immediate visibility into your current regulatory footprint.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link 
              to="/readiness"
              className="inline-flex items-center space-x-4 bg-white/10 backdrop-blur-md text-white border border-white/20 px-12 py-6 rounded-[2rem] font-black uppercase tracking-[0.2em] text-sm hover:bg-white/20 transition-all active:scale-95"
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-text-muted dark:text-text-dark-muted max-w-2xl mx-auto font-medium leading-relaxed italic">
              These accounts reflect systemic operational patterns frequently observed during the first 12 months of operating authority.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-red-50/50 dark:bg-red-950/20 p-10 rounded-[3rem] border border-red-100 dark:border-red-900/30 flex flex-col shadow-sm transition-all hover:bg-red-100/40 dark:hover:bg-red-900/40">
                <Quote className="text-red-600 mb-6" size={32} />
                <p className="text-[17px] text-slate-700 dark:text-slate-100 italic leading-relaxed mb-8 flex-grow font-serif">"{card.quote}"</p>
                <div className="h-px w-12 bg-red-200 dark:bg-red-800 mb-6"></div>
                <p className="text-[10px] font-black uppercase tracking-widest text-authority-blue dark:text-signal-gold opacity-80">— {card.author}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="roadmap" className="py-32 bg-slate-50 dark:bg-primary-dark border-y border-border-light dark:border-border-dark">
      ...
      {/* 6. DIFFERENTIATION */}
      <section className="py-32 bg-slate-50 dark:bg-primary-dark border-y border-slate-200 dark:border-border-dark">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-black font-serif text-authority-blue dark:text-white uppercase tracking-tight mb-4">
      ...
      <section className="py-32 bg-slate-50 dark:bg-primary-dark">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-white dark:bg-surface-dark p-10 md:p-16 rounded-[4rem] border-4 border-signal-gold shadow-2xl relative overflow-hidden mb-16">
            <div className="absolute top-0 right-0 p-8 opacity-5 rotate-12 pointer-events-none">
              <ShieldCheck size={200} className="text-authority-blue dark:text-white" />
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="flex items-baseline mb-8">
                <span className="text-2xl font-bold text-signal-gold mr-1">$</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-left w-full max-w-2xl mb-12">
                {[
                  ...
                  "46 In-Depth Video Lessons",
                  "50+ Audit-Ready Templates",
                  "ALL Web-Based Calculators",
              ...
              <Link to="/pricing" className="bg-authority-blue text-white px-16 py-6 rounded-2xl font-black uppercase tracking-[0.25em] text-sm hover:bg-steel-blue transition-all shadow-2xl active:scale-95">
                Enroll In The System Now
              </Link>
              
              <p className="mt-12 text-[11px] font-black text-text-muted uppercase tracking-widest opacity-60 max-w-md mx-auto leading-relaxed">
                This is the current entry point. <br/>The full standard investment will increase as the system matures.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-authority-blue relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link to="/readiness" className="inline-flex items-center space-x-3 bg-white text-authority-blue px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-signal-gold transition-all shadow-2xl active:scale-95">
              <span>Check My Readiness</span>
              <ArrowRight size={18} />
            </Link>
