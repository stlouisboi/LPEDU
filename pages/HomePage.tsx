          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-4 xl:col-span-4 flex flex-col items-center lg:items-start group">
              ...
              <div className="mt-12 w-full max-w-[400px] p-6 bg-white/5 backdrop-blur-xl rounded-[1.5rem] border border-white/10 shadow-2xl">
                ...
                <p className="text-[13px] font-serif text-white/50 leading-relaxed mb-4">
                  “Because 1 in 5 new authorities fail their first audit, we built LaunchPath to close the compliance knowledge gap that causes preventable shutdowns.”
                </p>
