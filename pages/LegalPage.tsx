    ...
    <div className="bg-white dark:bg-primary-dark min-h-screen py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          <section>
            <h2 className="text-2xl font-bold mb-6 text-authority-blue">Compliance Disclaimer</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 text-authority-blue">Privacy Policy</h2>
            <div className="prose dark:prose-invert max-w-none text-text-muted">
              <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 text-authority-blue">Terms of Service</h2>
            <div className="prose dark:prose-invert max-w-none text-text-muted">
              <p className="mb-4">
