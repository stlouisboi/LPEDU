    ...
    <div className="bg-primary-light dark:bg-primary-dark min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-16 gap-6">
          ...
          <div className="flex items-center space-x-3 bg-white dark:bg-surface-dark px-5 py-3 border border-slate-100 dark:border-white/10 rounded-2xl shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
              ...
              <div className="grid grid-cols-1 gap-4">
                {COURSE_MODULES.map((module) => (
                  <Link 
                    ...
                    className="flex items-center justify-between p-8 bg-white dark:bg-surface-dark border border-slate-100 dark:border-white/5 rounded-[2.5rem] hover:shadow-2xl hover:translate-x-2 transition-all group"
                  >
                    <div className="flex items-center space-x-8">
                      <div className="w-14 h-14 bg-slate-50 dark:bg-white/5 rounded-2xl flex items-center justify-center font-black text-authority-blue dark:text-signal-gold shadow-inner text-lg">
                        {module.id}
                      </div>
                      <div>
                    ...
                    <div className="w-10 h-10 bg-slate-50 dark:bg-white/5 rounded-full flex items-center justify-center group-hover:bg-authority-blue group-hover:text-white transition-all text-slate-300">
            ...
            <section className="bg-white dark:bg-surface-dark rounded-[3.5rem] p-10 md:p-14 border border-slate-100 dark:border-white/5 shadow-sm">
              <div className="flex items-center justify-between mb-10">
                <h2 className="text-xs font-black uppercase tracking-[0.4em] text-authority-blue dark:text-white/40 flex items-center">
                  <ClipboardList size={18} className="mr-3" /> Task Registry
                </h2>
                <span className="text-[10px] font-bold text-slate-300 dark:text-white/20 uppercase tracking-widest">Operator Personalized</span>
              </div>
              ...
              <form onSubmit={addTask} className="mb-10 flex gap-4">
                <input 
                  ...
                  className="flex-grow bg-slate-50 dark:bg-slate-950 border-2 border-transparent focus:border-authority-blue dark:focus:border-signal-gold outline-none rounded-2xl px-6 py-4 font-bold text-sm transition-all shadow-inner dark:text-white"
                />
                <button 
                  type="submit"
              ...
              <div className="space-y-3">
                {tasks.map((task) => (
                  <div 
                    key={task.id} 
                    className="flex items-center justify-between p-5 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-white/5 rounded-2xl group transition-all hover:bg-white dark:hover:bg-white/5"
                  >
                ...
                {tasks.length === 0 && (
                  <div className="text-center py-12 opacity-30">
                    <ClipboardList size={48} className="mx-auto mb-4 dark:text-white" />
                    <p className="text-[10px] font-black uppercase tracking-widest dark:text-white">Registry Empty</p>
                  </div>
                )}
              </div>
            </section>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-white dark:bg-surface-dark border border-slate-100 dark:border-white/5 p-10 rounded-[3rem] shadow-sm">
               ...
               <div className="space-y-4">
                  <Link to="/ai-advisor" className="flex items-center justify-between p-5 bg-slate-50 dark:bg-slate-950 rounded-2xl hover:bg-authority-blue hover:text-white transition-all group border border-transparent dark:border-white/5">
                    <span className="text-[10px] font-black uppercase tracking-widest text-authority-blue dark:text-white">Neural Advisor</span>
                    <ChevronRight size={14} className="opacity-30 group-hover:opacity-100" />
                  </Link>
                  <Link to="/tools/tco-calculator" className="flex items-center justify-between p-5 bg-slate-50 dark:bg-slate-950 rounded-2xl hover:bg-authority-blue hover:text-white transition-all group border border-transparent dark:border-white/5">
                    <span className="text-[10px] font-black uppercase tracking-widest text-authority-blue dark:text-white">TCO Economic Engine</span>
                    <ChevronRight size={14} className="opacity-30 group-hover:opacity-100" />
                  </Link>
               </div>
            </div>
