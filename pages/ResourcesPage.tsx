  ...
  return (
    <div className="bg-[#FAF9F6] dark:bg-primary-dark min-h-screen font-sans text-slate-800 transition-colors duration-500 selection:bg-authority-blue/10">
      ...
      <section className="bg-white dark:bg-surface-dark border-b border-slate-200 dark:border-border-dark pt-32 pb-24 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto p-12 bg-slate-50 dark:bg-gray-900/50 border border-slate-200 dark:border-border-dark rounded-[3.5rem] text-left relative overflow-hidden shadow-sm">
            ...
            <p className="text-lg text-slate-600 dark:text-text-dark-primary leading-relaxed mb-8 font-medium italic">
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        <div className="mb-20">
          <p className="text-[11px] font-black uppercase tracking-[0.5em] text-authority-blue mb-4">01. Readiness & Risk Diagnostics</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            { 
              ...
              // ClipboardList icon is used here (fixed import above)
              icon: <ClipboardList />, 
              link: "/readiness" 
            }
          ].map((item, i) => (
            <div key={i} className="bg-white dark:bg-surface-dark p-12 rounded-[3.5rem] border border-slate-100 dark:border-border-dark shadow-sm hover:shadow-xl transition-all duration-500 group">
              <div className="w-16 h-16 bg-slate-50 dark:bg-gray-800 text-authority-blue dark:text-signal-gold rounded-2xl flex items-center justify-center mb-10 group-hover:scale-110 transition-transform shadow-inner">
              ...
              <p className="text-base text-slate-500 dark:text-text-dark-muted font-medium mb-12 leading-relaxed">{item.desc}</p>
              {item.isGated ? (
                <button 
      ...
      <section className="py-40 bg-authority-blue text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="mb-24">
            <p className="text-[11px] font-black uppercase tracking-[0.5em] text-signal-gold mb-4">02. Authority & Compliance Foundations</p>
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        <div className="mb-20">
          <p className="text-[11px] font-black uppercase tracking-[0.5em] text-authority-blue mb-4">03. Starter Templates & Operating Tools</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {[
            { title: "Driver Qualification File Starter Pack", icon: <User /> },
            { title: "Vehicle Maintenance Log (Basic)", icon: <Monitor /> },
            { title: "Accident Reporting Quick Form", icon: <FileWarning /> },
            { title: "Daily Compliance Activity Log", icon: <Clock /> },
            { title: "Recordkeeping Folder Structure Guide", icon: <HardDrive /> }
          ].map((tool, i) => (
            <div key={i} className="bg-slate-50 dark:bg-gray-900 p-10 rounded-[3rem] border border-slate-200 dark:border-border-dark flex flex-col items-center text-center group transition-all hover:bg-white hover:shadow-xl hover:border-authority-blue/20">
              <div className="w-16 h-16 bg-white dark:bg-surface-dark text-authority-blue dark:text-signal-gold rounded-2xl flex items-center justify-center mb-8 shadow-sm group-hover:rotate-6 transition-all border border-slate-100 dark:border-border-dark">
                {React.cloneElement(tool.icon as React.ReactElement, { size: 28 })}
              </div>
              <h4 className="text-xs font-black text-authority-blue dark:text-white uppercase leading-relaxed mb-8 flex-grow">{tool.title}</h4>
              <button 
                onClick={() => setSelectedGuide({title: tool.title, link: "#"})}
                className="mt-auto text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 hover:text-authority-blue transition-colors flex items-center"
              >
                Access File <ChevronRight size={10} className="ml-1" />
              </button>
            </div>
          ))}
        </div>
        
        <div className="mt-16 p-10 bg-authority-blue/5 border border-authority-blue/10 rounded-[2.5rem] text-center max-w-4xl mx-auto">
          <p className="text-[12px] font-black uppercase tracking-[0.4em] text-authority-blue leading-relaxed">
      ...
      <section className="py-40 bg-white dark:bg-surface-dark border-y border-slate-100 dark:border-border-dark">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-24">
            <p className="text-[11px] font-black uppercase tracking-[0.5em] text-authority-blue mb-4">04. Calculators & Decision Tools</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              // Calendar icon is used here (fixed import above)
        ...
        <div className="bg-red-50 dark:bg-red-950/10 border-2 border-red-100 dark:border-red-900/30 rounded-[5rem] p-12 md:p-24 relative overflow-hidden shadow-sm">
          ...
          <div className="relative z-10 max-w-5xl">
            <div className="inline-flex items-center space-x-4 bg-red-600 text-white px-6 py-3 rounded-full mb-12 shadow-xl">
              <ShieldAlert size={20} />
              <span className="text-[11px] font-black uppercase tracking-[0.5em]">05. Protection Protocol</span>
            </div>
               ...
               <div className="space-y-10">
                  <div className="space-y-6">
                    ...
                    <p className="text-lg text-slate-600 dark:text-text-dark-muted font-medium leading-relaxed">
                      The moment a DOT or MC number is filed, carrier information enters the public domain. This triggers a wave of predatory solicitations designed to exploit the New Entrant window. LaunchPath classifies these threats as <span className="font-black text-red-600">External Exposure Vectors</span>.
                    </p>
                    <p className="text-lg text-slate-600 dark:text-text-dark-muted font-medium leading-relaxed">
      ...
      <section className="py-40 max-w-7xl mx-auto px-6">
        <div className="mb-24 text-center">
          <p className="text-[11px] font-black uppercase tracking-[0.5em] text-authority-blue mb-4">06. Education Library</p>
      ...
      <section className="py-40 bg-slate-50 dark:bg-primary-dark border-y border-slate-100 dark:border-border-dark overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-24">
            <p className="text-[11px] font-black uppercase tracking-[0.5em] text-authority-blue mb-4">07. Field Lessons & Case Insights</p>
      ...
      <section className="py-48 bg-authority-blue text-center overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-black font-serif uppercase tracking-tight text-white mb-8">08. Faith-Aligned Stewardship</h2>
      ...
      <section className="py-60 bg-white dark:bg-primary-dark text-center border-t border-slate-100 dark:border-border-dark relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <p className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-400 mb-10">09. Path Forward</p>
          <h2 className="text-5xl lg:text-8xl font-black font-serif uppercase tracking-tighter text-authority-blue dark:text-white mb-12 leading-[0.9]">When You’re Ready <br/>for <span className="text-signal-gold italic">Structured <br/>Implementation.</span></h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10">
            ...
            <Link to="/learning-path" className="w-full sm:w-auto px-20 py-10 bg-white dark:bg-gray-800 text-authority-blue dark:text-white border-2 border-authority-blue rounded-[3rem] font-black uppercase tracking-[0.4em] text-xs active:scale-95 transition-all shadow-xl hover:bg-slate-50">
