    ...
    <div className="bg-primary-light dark:bg-primary-dark min-h-screen py-20 animate-in fade-in duration-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-black font-display text-authority-blue dark:text-white tracking-tighter mb-4 leading-tight">
            Your Compliance Resources Are Ready, <br/>
            <span className="text-signal-gold lowercase">{firstName}!</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-500 dark:text-text-dark-muted font-medium max-w-2xl mx-auto leading-relaxed">
          ...
          {downloads.map((item, idx) => (
            <div key={idx} className="relative group">
              ...
              <div className="relative bg-white dark:bg-surface-dark border border-slate-100 dark:border-border-dark p-10 rounded-[2.5rem] shadow-xl flex flex-col h-full hover:translate-y-[-4px] transition-all duration-300">
                ...
                <div className="w-16 h-16 bg-slate-50 dark:bg-gray-800 text-authority-blue dark:text-signal-gold rounded-2xl flex items-center justify-center mb-8">
                  {item.icon}
                </div>
                
                <h3 className="text-xl font-black font-display text-authority-blue dark:text-white uppercase mb-4 leading-tight">
                  {item.title}
                </h3>
                
                <p className="text-slate-500 dark:text-text-dark-muted font-medium leading-relaxed mb-10 flex-grow">
                  {item.description}
                </p>
                ...
                <a 
                  ...
                  className="w-full bg-signal-gold text-white py-5 rounded-2xl font-black font-display uppercase tracking-[0.2em] text-xs flex items-center justify-center shadow-xl hover:bg-authority-blue transition-all active:scale-95 group/btn"
                >
        ...
        <div className="bg-authority-blue rounded-[3.5rem] p-12 md:p-20 text-white shadow-2xl relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-black font-display uppercase tracking-tight mb-8 leading-tight">
            ...
            <Link 
              to="/pricing" 
              className="inline-flex items-center space-x-3 bg-signal-gold text-authority-blue px-14 py-6 rounded-2xl font-black font-display uppercase tracking-widest text-sm hover:bg-white transition-all shadow-2xl active:scale-95 group"
            >
