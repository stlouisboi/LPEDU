...
const PortalInterstitial = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-primary-dark flex items-start justify-center pt-[15vh] sm:pt-[20vh] px-6 animate-in fade-in duration-700">
      <div className="max-w-md w-full text-center space-y-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-500 dark:text-text-dark-muted font-medium leading-relaxed uppercase text-[10px] tracking-[0.25em]">
            Credentials verified. <br/>Redirecting to secure environment.
          </p>
        </div>
