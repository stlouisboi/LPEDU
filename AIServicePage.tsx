              ...
              <div className="p-8 border-t border-border-light dark:border-border-dark bg-gray-50 dark:bg-gray-900/50">
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-white dark:bg-gray-800 border border-border-light dark:border-border-dark pl-6 pr-20 py-5 rounded-2xl focus:ring-4 focus:ring-authority-blue/10 outline-none transition-all shadow-sm"
                  />
                  <button 
                    onClick={handleSend}
                    disabled={isLoading}
                  ...
                  <div className="bg-slate-50 dark:bg-gray-800/50 p-8 rounded-[2.5rem] border border-border-light dark:border-border-dark space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea 
                        ...
                        placeholder="Describe the cinematic scene (e.g. A fleet of semis driving through a rain-slicked highway at night, lens flares, photorealistic)..."
                        className="w-full bg-white dark:bg-gray-800 border border-border-light rounded-2xl p-5 text-sm leading-relaxed outline-none focus:ring-4 focus:ring-authority-blue/10 transition-all"
                      />
                    </div>

                    <div className="space-y-3">
                      <label className="text-[10px] font-black uppercase tracking-widest text-text-muted">Animate Image (Image-to-Video)</label>
                  ...
                  {isGeneratingVideo ? (
                    <div className="flex-grow flex flex-col items-center justify-center bg-slate-50 dark:bg-gray-800/30 rounded-[2.5rem] border border-dashed border-border-light p-12 text-center space-y-6">
                      <div className="relative">
                        ...
                        <Sparkles className="absolute -top-2 -right-2 text-signal-gold animate-bounce" size={24} />
                      </div>
                      <div>
                        <h4 className="text-2xl font-bold font-serif mb-2">{genMessage}</h4>
                        <p className="text-sm text-text-muted">High-fidelity video rendering takes approximately 2-3 minutes. Do not refresh this page.</p>
                      </div>
                      <div className="w-full bg-slate-200 dark:bg-gray-700 h-1.5 rounded-full overflow-hidden">
                        <div className="bg-authority-blue h-full w-1/2 animate-[loading_3s_ease-in-out_infinite]"></div>
                      </div>
                    </div>
                  ) : videoResult ? (
                    <div className="bg-black rounded-[2.5rem] overflow-hidden shadow-2xl relative group">
                      ...
                      <div className="absolute top-6 left-6 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <span className="bg-white/90 px-3 py-1.5 rounded-full text-[10px] font-black uppercase text-authority-blue shadow-lg">Generated Asset</span>
                      </div>
                    ...
                    <div className="flex-grow flex flex-col items-center justify-center bg-slate-50 dark:bg-gray-800/30 rounded-[2.5rem] border border-border-light p-12 text-center opacity-50">
                      ...
                      <p className="text-sm text-text-muted max-w-xs mx-auto">Set your parameters and click "Generate" to visualize your compliance content.</p>
                    </div>
                  )}
                </div>
              </div>
